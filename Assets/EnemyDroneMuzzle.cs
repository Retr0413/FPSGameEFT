...
public class EnemyDroneMuzzle : MonoBehaviour
{
    ...
    {
        // タグで敵を検索
        GameObject[] enemyMobs = GameObject.FindGameObjectsWithTag("Player");
        GameObject[] enemyBosses = GameObject.FindGameObjectsWithTag("Player");
